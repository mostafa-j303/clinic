...
const Separator: React.FC<SeparatorProps> = ({ value }) => {
  return (
    <div className="text-white  relative text-4xl font-thin bg-gradient-to-b from-hovprimary border-t-0 via-hovprimary to-hovsecondary flex flex-col items-center shadow-secondary   border-primary transition duration-500  ">
